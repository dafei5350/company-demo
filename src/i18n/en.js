export default {
	...
	about: {
		...
		// about-question
		aboutJYWT1261: "Transaction Problem",
		aboutSCWT1640: "Market Issues",
		aboutMPTWT424: "MT4 platform problem",
		aboutKHWT1293: "Account Opening Problem",
		aboutCRJWT212: "Problems with deposits and withdrawals",
		aboutJYDC1680: "Trading Spread",
		aboutZZFW1392: "Value Added Service",
		aboutJYZH2055: "Trading Account",
		...
		aboutWMPTSYSZ: "Our platform has three types of accounts, and the accounts only charge the spread when the customer places an order. The European and American averages are 1.0, gold 0.2, crude oil 0.025, and our platform's marketing strategy is a platform with low spreads.",
		...
		aboutMNZHHZSZ: "The demo account and the real account are the same quotation source, but due to technical reasons, the real account and the demo account do not enjoy the same trading environment. Because the order of the demo account does not enter the real trading market, it does not have the same as the real account. Comparability. The demo account is designed to familiarize traders with the trading platform, so it cannot be used to bring a real trading experience.",
		...
		aboutZWAPLDKH: "As a client of Attuare Pty. Ltd., please ensure that your account maintains the minimum margin level before placing an order.",
		...
		aboutAPLRJLCR: "Attuare Pty. Ltd. deposit process is as follows:",
	...
	coop: {
		...
		coopWSBJDKHG: "Perfect and convenient customer management system",
		...
		coopQDDHDZYD: "Strong backing, professional training",
		...
		coopYJZJDZ91: "Commission is directly credited to the account",
	...
	plat: {
		...
		platKHTY1108: "Account Opening Experience",
